...
import co.edu.usbcali.wimbledon.dataaccess.dao.IPaisDAO;
...
public class PaisLogic implements IPaisLogic {
    ...
    */
    ...
    public void deletePais(Pais entity) throws Exception {
        ...
        try {
            personas = personaDAO.findByProperty("pais.paisId",
                    entity.getPaisId());
            ...
            paisDAO.deleteById(entity.getPaisId());
    ...
    public List<PaisDTO> getDataPais() throws Exception {
        try {
            ...
            for (Pais paisTmp : pais) {
                PaisDTO paisDTO2 = paisMapper.paisToPaisDTO(paisTmp);
