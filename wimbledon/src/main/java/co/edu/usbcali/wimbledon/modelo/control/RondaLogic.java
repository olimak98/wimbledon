...
public class RondaLogic implements IRondaLogic {
    ...
    */
    ...
    public void validateRonda(Ronda ronda) throws Exception {
        try {
            Set<ConstraintViolation<Ronda>> constraintViolations = validator.validate(ronda);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<Ronda> constraintViolation : constraintViolations) {
    ...
    public void deleteRonda(Ronda entity) throws Exception {
        ...
        if (entity.getRondaId() == null) {
            throw new ZMessManager().new EmptyFieldException("rondaId");
        }

        List<Partido> partidos = null;

        try {
            partidos = partidoDAO.findByProperty("ronda.rondaId",
                    entity.getRondaId());
            ...
            rondaDAO.deleteById(entity.getRondaId());
    ...
    public List<RondaDTO> getDataRonda() throws Exception {
        try {
            ...
            for (Ronda rondaTmp : ronda) {
                RondaDTO rondaDTO2 = rondaMapper.rondaToRondaDTO(rondaTmp);
    ...
    public Ronda getRonda(Integer rondaId) throws Exception {
        ...
        try {
            entity = rondaDAO.findById(rondaId);
        } catch (Exception e) {
